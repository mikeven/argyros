		  ...
		  <ul class="text-right">
			<li class="customer-links hidden-xs">
				<ul id="accounts" class="list-inline">
						...
						<form method="post" action="#" id="customer_login" accept-charset="UTF-8"><input type="hidden" value="customer_login" name="form_type"><input type="hidden" name="utf8" value="✓">
							<div id="bodyBox">
								<ul class="control-container customer-accounts list-unstyled">
									...
									<li class="clearfix">
										<a class="action btn btn-1" href="register.html">Crear cuenta</a>
									</li>
								</ul>
							</div>
						</form>
					...
					<li>/</li>   
					<li class="register">
						<a href="register.html" id="customer_register_link">Crear cuenta</a>
					</li> 
				</ul>
			</li>      
			<li id="widget-social">
									...
									<div class="megamenu-container megamenu-container-1 dropdown-menu banner-bottom mega-col-4" style="">
										<ul class="sub-mega-menu">
											...
											<ul>
												...
												<li class="list-title">Gargantillas</li>
												<br>
											...
											<li>
												<ul>
													<li class="list-title">Complementarios</li>
													<li class="list-unstyled li-sub-mega">
													<a href="#">Balanzas</a>
													</li>
													<li class="list-unstyled li-sub-mega">
											...
											<ul>
												...
												<li class="list-unstyled li-sub-mega">
													<a href="product.html">Medallas</a>
												</li>
											</ul>
											</li>
											<ul>
												<li class="list-title">Otras joyas</li>
												<li class="list-unstyled li-sub-mega">
												<a href="#">Pisacorbata</a>
												</li>
												<li class="list-unstyled li-sub-mega">
												<a href="#">Pisabilletes</a>
												</li>
												<li class="list-unstyled li-sub-mega">
												<a href="#">Yuntas</span>
												</a>
