<?php
	...
	function productosCategoriaSubcategoria( $dbh, $idc, $idsc ){
		...
		$q = "select p.id as idp, p.code, p.name, p.description, co.name as pais, ca.id as idc,  
		ca.name as categoria, ca.uname as ucat, m.name as material, dp.id as iddet, dp.color_id as id_color, 
		c.name as color, c.uname as ucolor, dp.treatment_id as id_bano, t.name as bano, t.uname as ubano, 
