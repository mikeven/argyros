...
<head>
  ...
  <title>Revisión de orden::Argyros</title>
	...
	<style type="text/css">
		#col-main{ margin-right: 70px; max-height: 450px; overflow-y: scroll; }
									...
									<div class="row sb-wrapper unpadding-top">
										...
										<ul id="customer_detail" class="list-unstyled sb-content">
											...
											<li id="cli_orden_obs">
												...
												<label class="control-label" for="orden_obs">Nota</label>
												<textarea name="observaciones" id="obs_cliente" 
