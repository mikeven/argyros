...
<html lang="en">
  ...
  <body class="nav-md">
            ...
            <div class="row">
              ...
              <div class="col-md-5 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form id="frm_rcatalogo" data-parsley-validate class="form-horizontal form-label-left" 
                          action="" method="post">
                      ...
                      <div id="panel_opciones_1">
                          ...
                          <div class="form-group"><!-- Peso -->
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-6">
                              <input type="text" id="flt_pes_min" class="form-control input_flt" placeholder="Mín gr." name="peso_min" value="" 
                              onkeypress="return isNumberKey(event)">
                            </div>
                            <div class="col-md-4 col-sm-4 col-xs-6">
                              <input type="text" id="flt_pes_max" class="form-control input_flt" placeholder="Máx gr." name="peso_max" value="" 
                              onkeypress="return isNumberKey(event)">
                            </div>
                          </div>
                          ...
                          <div class="form-group"><!-- Países -->
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Países </label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <select id="rpais" name="pais" class="form-control selectpicker" 
                              title="Seleccione">
                              <option value="">Seleccione</option>
                          ...
                          <div class="form-group"><!-- Palabras Claves -->
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Palabras claves</label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input type="text" id="flt_pal_claves" class="form-control input_flt" 
                                placeholder="Palabras claves" name="claves">
                                <div> Usar comas para múltiples palabras </div>  
                            </div>
                          </div><!-- Palabras Claves -->
                      ...
                      <div id="panel_opciones_2" class="form-group" style="display: none;">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-9 col-sm-9 col-xs-6">
                            <input type="text" id="identificador_ids" class="form-control input_flt" 
                            placeholder="Id producto-Id detalle" name="identificador">
                            <div>
                              Usar comas para múltiples identificadores, sin #
                            </div>
                          </div>
                        </div>
    ...
    <script src="js/fn-product.js"></script>
	  <script src="js/fn-catalogue.js"></script>
  </body>
</html>
